...
const steps = [
  ...
  },
  {
    ...
    title: "ネットワークを追加する",
    emoji: "🌐",
    description: "Arbitrum Oneネットワークをウォレットに追加します。",
    details: [
      { text: "ChainListにアクセス", link: "https://chainlist.org/?search=arbitrum+one" },
      { text: "「Arbitrum One」を検索して「Add to MetaMask」をクリック" },
      { text: "MetaMaskのポップアップで「承認」を選択" },
      { text: "MetaMaskの上部ネットワーク欄が「Arbitrum One」になっていることを確認" },
    ],
  ...
  },
  {
    ...
    title: "USDCを入手する",
    emoji: "💰",
    description: "運用に使うUSDCをウォレットに送金します。",
    details: [
      { text: "日本の暗号資産取引所（bitbank、GMOコイン等）でETHを購入" },
      { text: "ETHをMetaMaskのアドレスに送金" },
      { text: "Uniswap等のDEXでETH → USDCにスワップ", link: "https://app.uniswap.org/" },
      { text: "または取引所からArbitrum One経由で直接USDCを送金" },
    ],
    tip: "最低100 USDC + ガス代用のETH（約0.001 ETH ≈ 数百円）が必要です。",
  },
  {
    id: 4,
