...
def test_run_job_sell_creates_withdraw_proposals(db_session):
    ...
    u = _add_active_user(db_session, "seller@example.com")
    _add_fund_allocation(db_session, u)
    db_session.commit()
...
def test_buy_creates_proposal_only_for_require_approval_users(db_session):
    ...
    u_approval = _add_active_user(db_session, "approval@example.com", execution_policy="require_approval")
    ...
    _add_fund_allocation(db_session, u_approval)
    db_session.commit()
