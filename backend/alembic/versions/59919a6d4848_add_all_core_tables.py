...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_portfolio_history_period_start'), 'portfolio_history', ['period_start'], unique=False)
    op.create_index(op.f('ix_portfolio_history_period_type'), 'portfolio_history', ['period_type'], unique=False)
    ...
    op.create_index(op.f('ix_portfolio_snapshots_recorded_at'), 'portfolio_snapshots', ['recorded_at'], unique=False)
    ...
    op.create_index(op.f('ix_fee_calculations_user_id'), 'fee_calculations', ['user_id'], unique=False)
    op.create_table('high_water_marks',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=False),
    ...
    op.create_index(op.f('ix_high_water_marks_user_id'), 'high_water_marks', ['user_id'], unique=True)
